...
const devChart = async (cryptoWeekly,coinName,chartTitle,yAxisTitle) => {
    // const cryptoWeekly = commitData(data);
    let labels = [];
    Object.keys(cryptoWeekly).forEach(week => {
            ...
            "datasets": [
                {
                    ...
                    "data": Object.values(cryptoWeekly),
                },
            ]
        },
        "options": {
            ...
            "title": {
                "display": true,
                // Weekly Commit Data trends
                "text": `${coinName} ${chartTitle}`
            },
            "scales": {
                "xAxes": [
                    {
