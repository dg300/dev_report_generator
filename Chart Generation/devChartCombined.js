...
const commitChartCombined = async (bitcoinMonthly, ethereumMonthly, cosmosMonthly) => {
        ...
        "data": {
            ...
            "datasets": [
                ...
                },
                {
                    ...
                    "data": Object.values(cosmosMonthly)
                }
            ]
        },
        "options": {
            ...
            "title": {
                "display": true,
                "text": "Active Developers Comparison"
            },
            "scales": {
                "xAxes": [
                    {
